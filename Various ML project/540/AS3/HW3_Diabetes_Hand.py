...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 15 15:32:16 2019
...
file1= csv.reader(open('/Users/appobs/Desktop/hw/540/week5/HW3/Pima_Diabetes.csv'), delimiter=',', quotechar='"')
...
if binning==1 and cross_val==1:
    ...
    start_ts=time.time()
    clf= MLPClassifier(activation= 'logistic',solver='adam', alpha=0.0001, max_iter=200, hidden_layer_sizes=(10, ),random_state=rand_st)
    scores= cross_validate(clf, data_np, target_np, scoring=scorers, cv=5)
