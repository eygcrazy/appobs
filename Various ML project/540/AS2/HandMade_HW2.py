#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#Created on Sat Oct  5 12:19:03 2019
"""
...
file1= csv.reader(open('/Users/appobs/Desktop/hw/540/week4/HW2/WineQuality_Red.csv'), delimiter=',', quotechar='"')
...
if norm_features==1:
    ...
    data_np= scale(data_np, axis=0, with_mean=True, with_std=True, copy=True)
...
if feat_select==1:
    ...
    if fs_type==2:
        rgr = RandomForestRegressor(n_estimators=100, max_depth=None, min_samples_split=3, criterion = 'mse', max_features=.33, random_state=rand_st)
